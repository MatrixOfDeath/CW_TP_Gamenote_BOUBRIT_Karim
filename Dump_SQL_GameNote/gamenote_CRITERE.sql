...
CREATE TABLE `CRITERE` (
  `idCRITERE` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `critere` varchar(45) NOT NULL,
  PRIMARY KEY (`idCRITERE`,`critere`)
...
INSERT INTO `CRITERE` VALUES (1,'graphisme'),(2,'gameplay'),(3,'lifetime');
